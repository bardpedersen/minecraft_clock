...
#define MINECRAFT_NIGHT_1 RGB_(24, 22, 22)
#define MINECRAFT_NIGHT_2 RGB_(30, 28, 28)
#define MINECRAFT_MOON_1  RGB_(88, 84, 110)
#define MINECRAFT_MOON_2  RGB_(110, 105, 138)
